...
class FDI:
    ...
    @staticmethod
    def inject(origin_data, func, *args):
        return func(origin_data, *args)


if __name__ == '__main__':
    data = [1, 2, 3, 4, 5, 6, 7, 8, 9]
    print(FDI.fdi1(data, 0.6))
    print(FDI.fdi2(data, 6))
    print(FDI.fdi3(data, 5))
    print(FDI.fdi4(data, 0, 3))
    print(FDI.fdi6(data, 0.4, 0.6))
